...
export const EditPoojaAPI = async (id,data) => {
  const transformData = (data) => {
    ...
    formData.append("locationHi", data.locationHi?.value || "");
  ...
  const response = await axiosInstance.put(`/api/poojas/${id}`, formattedData, {
    headers: {
